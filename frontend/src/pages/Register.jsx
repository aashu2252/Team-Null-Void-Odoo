...
export default function Register() {
  ...
  const handleRegisterSubmit = async (values, { setSubmitting }) => {
    // Exclude confirmPassword from database save payload
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md z-10 text-center">
        ...
        <p className="mt-2 text-sm text-slate-400">
          Create an enterprise account to get started
        </p>
      </div>
        ...
        <div className="bg-slate-905/40 backdrop-blur-xl py-8 px-4 border border-slate-800/80 shadow-2xl sm:rounded-3xl sm:px-10">
                  ...
                  <div className="mt-1.5">
                    <Field
                      ...
                      className={`block w-full rounded-xl bg-slate-900 border ${
                        errors.fullName && touched.fullName ? 'border-red-500 focus:ring-red-500' : 'border-slate-800 focus:border-cyan-500 focus:ring-cyan-500'
                      } text-white px-4 py-2.5 text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-offset-0 transition-all duration-200`}
                ...
                <div>
                  ...
                  <div className="mt-1.5 relative">
                    <Field
                      ...
                      } text-white pl-4 pr-12 py-2.5 text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-offset-0 transition-all duration-200`}
                ...
                <div>
                  ...
                  <div className="mt-1.5">
                    <Field
                      ...
                      type={showPassword ? 'text' : 'password'}
                      className={`block w-full rounded-xl bg-slate-900 border ${
                        errors.confirmPassword && touched.confirmPassword ? 'border-red-500 focus:ring-red-500' : 'border-slate-800 focus:border-cyan-500 focus:ring-cyan-500'
                      } text-white px-4 py-2.5 text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-offset-0 transition-all duration-200`}
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-400">
              ...
              <Link to="/login" className="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors duration-150">
                Sign in
              </Link>
            </p>
          </div>
